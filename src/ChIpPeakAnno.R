...
peaks <- toGRanges(paste0(data_dir, 'H3K4me3_GM12878_intersect_G4.bed'), format="BED")
peaks[1:2]
...
write.table(anno_df, file=paste0(data_dir, 'H3K4me3_GM12878_intersect_G4.genes.txt'),
            col.names = TRUE, row.names = FALSE, sep = '\t', quote = FALSE)

uniq_genes_df <- unique(anno_df['symbol'])
write.table(uniq_genes_df, file=paste0(data_dir, 'H3K4me3_GM12878_intersect_G4.genes_uniq.txt'),
